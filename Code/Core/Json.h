...
namespace json
{
	...
	inline void EncodeString(std::vector<uint8_t> &data, const std::u32string &str)
	{
	...
	protected:
		...
		void parseValue(TokenIterator &iterator, TokenIterator end)
		{
			if( iterator == end )
				throw std::runtime_error("Unexpected end of data");
		...
		template <class TokenIterator>
		void parseObject(TokenIterator &iterator, TokenIterator end)
		{
			if( iterator == end )
				throw std::runtime_error("Unexpected end of data");
		...
		template <class TokenIterator>
		void parseArray(TokenIterator &iterator, TokenIterator end)
		{
			if( iterator == end )
				throw std::runtime_error("Unexpected end of data");
